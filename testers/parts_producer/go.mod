module github.com/LoniasGR/hyperledger-fabric-sla-chaincode/testers/parts_producer

go 1.18

require (
	github.com/LoniasGR/hyperledger-fabric-sla-chaincode/lib v0.0.0-20220506112646-711edfa1382e
